...
<img src="source/species.png" alt="Leap Image" width="350" style="float: center;"/>
#### **2. Sample Collection**
...
### **Prototype**
We will release ten specialized prototypes to a selected group of experts in order to rigorously test the beta version. These prototypes represent the most advanced iteration of our current development cycle and are designed to provide a realistic preview of the system’s core functionalities. By distributing a limited number of units, we ensure that the evaluation remains focused, controlled, and aligned with our technical objectives.

Throughout the testing period, the participating experts will provide structured feedback regarding performance, usability, and potential improvements. Their insights will be essential for refining the final version, correcting unexpected issues, and validating the system’s effectiveness in real-world scenarios. This targeted beta testing phase will significantly enhance reliability and help us prepare for a broader public release.
